...
# Start YOLO Service (Python) on port 8000
Write-Host "`n[1/3] Starting YOLO Service on port 8000..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:PORT='8000'; cd 'C:\Users\ASUS\Desktop\Vision aid\yolo-service'; venv\Scripts\python.exe app.py" -WindowStyle Normal
...
# Start Front-end (React) - forcing port 3001
